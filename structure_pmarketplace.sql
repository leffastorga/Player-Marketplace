...
--
-- Host: localhost    Database: pmarketplace_dev
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `cards_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cards_attribute` (
  ...
  `attribute_value` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `scheduled_buys`
--

DROP TABLE IF EXISTS `scheduled_buys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `scheduled_buys` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `card_id` int(11) NOT NULL,
...
--
-- Table structure for table `transaction_buys`
--
...
-- Dump completed on 2021-06-11  9:43:12
